...
public class Hand : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        controller.activateAction.action.started += Action;
        controller.activateAction.action.canceled += StopAction;
    ...
    private void Action(InputAction.CallbackContext ctx)
    {
        ...
        {
            if(heldObject.GetComponent<InteractuableItems>() != null) heldObject.GetComponent<InteractuableItems>().Action();
        }
    }

    private void StopAction(InputAction.CallbackContext ctx)
    {
        if(isGrabbing || heldObject) 
        {
            if(heldObject.GetComponent<InteractuableItems>() != null) heldObject.GetComponent<InteractuableItems>().StopAction();
        }
    }
